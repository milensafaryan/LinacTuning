...
for a in range(1,8):
    for b in range(1,5):
        request_list.append('L:D%s%sLM@e,52,e,0'%(a,b))
...
if device=='RFQ':
    request_list.insert(0,'L:RFQPAH.SETTING@e,52,e,0')
    request_list.remove('L:RFQPAH@e,52,e,0')
elif device=='RFB':
    request_list.insert(0,'L:RFBPAH.SETTING@e,52,e,0')
    request_list.remove('L:RFBPAH@e,52,e,0')
elif device=='V5Q':
    request_list.insert(0,'L:V5QSET.SETTING@e,52,e,0')
    request_list.remove('L:V5QSET@e,52,e,0')
else:
